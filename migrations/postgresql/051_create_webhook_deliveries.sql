...
CREATE TABLE IF NOT EXISTS webhook_deliveries (
    ...
    next_retry_at TIMESTAMPTZ,  -- Timestamp for next retry
    attempted_at TIMESTAMPTZ,  -- Timestamp of most recent attempt
    completed_at TIMESTAMPTZ,  -- Timestamp of final completion
