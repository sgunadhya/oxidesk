...
INSERT INTO system_config (`key`, `value`, description, updated_at) VALUES
    ('availability.inactivity_timeout_seconds', '300', 'Time in seconds before online agent goes away (default 5 min)', NOW()),
    ('availability.max_idle_threshold_seconds', '1800', 'Time in seconds before away agent is reassigned (default 30 min)', NOW());
