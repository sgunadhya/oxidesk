...
ALTER TABLE users ADD COLUMN deleted_at TEXT NULL DEFAULT NULL;
ALTER TABLE users ADD COLUMN deleted_by TEXT NULL DEFAULT NULL;
CREATE INDEX idx_users_deleted_at ON users(deleted_at);

-- Add soft delete fields to inboxes table
ALTER TABLE inboxes ADD COLUMN deleted_at TEXT NULL DEFAULT NULL;
ALTER TABLE inboxes ADD COLUMN deleted_by TEXT NULL DEFAULT NULL;
