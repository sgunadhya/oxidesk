...
ALTER TABLE sessions ADD COLUMN last_accessed_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE sessions ADD COLUMN auth_method VARCHAR(20) NOT NULL DEFAULT 'password';
ALTER TABLE sessions ADD COLUMN provider_name VARCHAR(100);
