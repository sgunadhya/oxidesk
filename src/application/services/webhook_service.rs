...
impl WebhookService {
    ...
    pub async fn list_webhook_deliveries(
    ...
    ) -> ApiResult<crate::domain::entities::DeliveryListResponse> {
        ...
        let delivery_responses: Vec<crate::domain::entities::DeliveryResponse> = deliveries
            .into_iter()
            .map(crate::domain::entities::DeliveryResponse::from)
            .collect();

        Ok(crate::domain::entities::DeliveryListResponse {
