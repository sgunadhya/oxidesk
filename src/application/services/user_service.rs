...
impl UserService {
    ...
    pub async fn create_user(&self, user: &crate::domain::entities::User) -> ApiResult<()> {
        self.user_repo.create_user(user).await
    }

    pub async fn get_user_by_id(&self, id: &str) -> ApiResult<Option<crate::domain::entities::User>> {
    ...
    pub async fn get_user_by_email_and_type(
        &self,
        email: &str,
        user_type: &crate::domain::entities::UserType,
    ) -> ApiResult<Option<crate::domain::entities::User>> {
        self.user_repo
    ...
    pub async fn list_users(
        ...
        limit: i64,
        offset: i64,
        user_type_filter: Option<crate::domain::entities::UserType>,
    ) -> ApiResult<(Vec<crate::domain::entities::User>, i64)> {
        self.user_repo
...
///
/// ```
/// use oxidesk::application::services::user_service::parse_email_display_name;
