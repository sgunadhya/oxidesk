...
pub struct AuthResult {
    pub session: crate::domain::entities::Session,
...
impl AuthService {
    ...
    pub async fn authenticate(
        ...
        use crate::domain::entities::{Session, UserType};
        ...
        // AuthService expects crate::domain::entities::Role in AuthResult.
        ...
        // `AuthResult` has `pub roles: Vec<crate::domain::entities::Role>`.
        // I need to map them.

        let model_roles: Vec<crate::domain::entities::Role> = roles
            .into_iter()
