...
impl AvailabilityService {
    ...
    pub async fn get_availability(
        &self,
        agent_id: &str,
    ) -> ApiResult<crate::domain::entities::AvailabilityResponse> {
        let agent = self
            .agent_repo
            .get_agent_by_user_id(agent_id)
            .await?
        ...
        Ok(crate::domain::entities::AvailabilityResponse {
            agent_id: agent.id,
    ...
    pub async fn get_activity_logs(
        ...
        limit: i64,
        offset: i64,
    ) -> ApiResult<crate::domain::entities::ActivityLogResponse> {
        let (logs, total) = self
            .availability_repo
        ...
        Ok(crate::domain::entities::ActivityLogResponse {
            logs,
            total,
