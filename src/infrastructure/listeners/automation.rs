...
use crate::EventBus;
use crate::SlaService;
use crate::SystemEvent;
use std::sync::Arc;
use tokio_stream::StreamExt;

pub fn start_automation_listener(
    ...
    tokio::spawn(async move {
        ...
        let tag_repo_bg = TagRepository::new(automation_db.clone());
        let action_executor_bg = ActionExecutor::new(
            Arc::new(automation_db.clone()) as Arc<dyn ConversationRepository>,
            Arc::new(automation_db.clone()) as Arc<dyn UserRepository>,
            Arc::new(automation_db.clone()) as Arc<dyn AgentRepository>,
            Arc::new(automation_db.clone()) as Arc<dyn TeamRepository>,
            tag_repo_bg,
            Arc::new(automation_db.clone()) as Arc<dyn ConversationTagRepository>,
        );
        let automation_rule_service = Arc::new(AutomationService::new(
            Arc::new(automation_db.clone()) as Arc<dyn AutomationRepository>,
            action_executor_bg,
