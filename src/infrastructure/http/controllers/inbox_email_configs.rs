use crate::{
    infrastructure::http::middleware::{ApiResult, AppState, AuthenticatedUser, ApiError},
    domain::entities::{CreateInboxEmailConfigRequest, InboxEmailConfig, UpdateInboxEmailConfigRequest},
};
