...
impl Database {
    ...
    */
    ...
    // ========== Holiday Calendar Operations (Feature 029) ==========
    ...
    pub async fn get_holiday(&self, id: &str) -> ApiResult<Option<crate::models::Holiday>> {
        let holiday = sqlx::query_as::<_, crate::models::Holiday>("SELECT * FROM holidays WHERE id = ?")
            .bind(id)
            .fetch_optional(&self.pool)
            .await?;
    ...
    pub async fn list_holidays(&self) -> ApiResult<Vec<crate::models::Holiday>> {
        let holidays = sqlx::query_as::<_, crate::models::Holiday>(
    ...
    pub async fn update_holiday(
        ...
        let current = self.get_holiday(id).await?
    ...
    fn encrypt_password_field(&self, plaintext: &str) -> ApiResult<String> {
        use crate::utils::encryption::{encrypt_password, is_encryption_enabled};
